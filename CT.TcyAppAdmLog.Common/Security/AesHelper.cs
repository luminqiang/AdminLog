using CT.TcyAppAdmLog.Common.Extensions;
...
namespace CT.TcyAppAdmLog.Common.Security
{
    /// <summary>
    /// AEA加密解密辅助类
    /// </summary>
    public class AesHelper
    {
        ...
        /// 获取 加密密钥
        /// </summary>
        public string Key => SecurityConstant.AES_Key;
        ...
        /// 加密字节数组
        /// </summary>
        private static byte[] Encrypt(byte[] decodeBytes, string key, bool needIV = false)
        {
        ...
        /// 解密字节数组
        /// </summary>
        private static byte[] Decrypt(byte[] encodeBytes, string key, bool needIV = false)
        {
        ...
        /// 加密字符串，输出为Base64字符串
        /// </summary>
        private static string Encrypt(string source, string key, bool needIV = false)
        {            
        ...
        /// 解密字符串，输入为Base64字符串
        /// </summary>
        private static string Decrypt(string source, string key, bool needIV = false)
        {
            source.CheckNotNull("source");
        ...
        /// 加密文件
        /// </summary>
        private static void EncryptFile(string sourceFile, string targetFile, string key, bool needIV = false)
        {
        ...
        /// 解密文件
        /// </summary>
        private static void DecryptFile(string sourceFile, string targetFile, string key, bool needIV = false)
        {
            sourceFile.CheckFileExists("sourceFile");
            targetFile.CheckNotNullOrEmpty("targetFile");
